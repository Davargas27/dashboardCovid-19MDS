...
import FilterListIcon from '@material-ui/icons/FilterList';
    ...
    export default  function EnhancedTable(props) {
        ...
        const toValid  = Math.max.apply(Math, props.data.map(function(o) { return o.cases; }));
        const toValidR  = Math.max.apply(Math, props.data.map(function(o) { return o.recovered; }));
        const toValidD  = Math.max.apply(Math, props.data.map(function(o) { return o.deaths; }));
                    ...
                    <TableBody>
                        ...
                        .map((row, index) => {
                            ...
                            >
                                ...
                                <TableCell component="th" id={labelId} scope="row" padding="none" align="left">{row.date}</TableCell>
                                <TableCell align="right"  bgcolor={(row.cases == toValid)?"#F5FA4B" :"white"}>{row.cases}</TableCell>
                                <TableCell align="right">{row.Ncases}</TableCell>
                                <TableCell align="right" bgcolor={ (row.recovered== toValidR)? "#92F37A":"white"}>{row.recovered}</TableCell>
                                <TableCell align="right">{row.Nrecovered}</TableCell>
                                <TableCell align="right" bgcolor={ (row.deaths== toValidD)? "#F15252" :"white"}>{row.deaths}</TableCell>
