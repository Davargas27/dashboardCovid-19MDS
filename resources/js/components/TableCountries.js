...
import Button from '@material-ui/core/Button';
    ...
    const headCells = [
        { id: 'name', numeric: false, disablePadding: true, label: 'Name Country' },
    ...
    export default  function EnhancedTable(props) {
        ...
        const handleChangeRowsPerPage = (event) => {  setRowsPerPage(parseInt(event.target.value, 1)); setPage(0);};
                        ...
                        .map((row, index) => {
                            ...
                            >
                                ...
                                <TableCell component="th" id={labelId} scope="row" padding="none">
                                    <Button href={url}  color="primary" size="small">
                                        Link
                                    </Button>
                                </TableCell>
                            </TableRow>
